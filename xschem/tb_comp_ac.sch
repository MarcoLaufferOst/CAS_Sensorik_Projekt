...
C {code.sym} 360 -30 0 0 {name=s1 only_toplevel=false value="
...
C {vsource.sym} -230 10 0 0 {name=V1 
value=AC 1 
savecurrent=false}
C {vsource.sym} -230 70 0 0 {name=Vcm value=0 savecurrent=false}
C {gnd.sym} -230 100 0 0 {name=l5 lab=GND}
