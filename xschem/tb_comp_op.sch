...
C {devices/vsource.sym} -170 60 0 0 {name=V1 value=2 savecurrent=false}
...
C {devices/vsource.sym} -230 60 0 0 {name=V2 value=2 savecurrent=false}
C {devices/lab_wire.sym} -40 30 0 0 {name=p5 sig_type=std_logic lab=vbias}
C {comparator.sym} 150 0 0 0 {name=x1}
C {devices/lab_wire.sym} -70 -20 0 0 {name=p3 sig_type=std_logic lab=vinp}
C {devices/lab_wire.sym} -70 0 0 0 {name=p4 sig_type=std_logic lab=vinn}
